...
// Asegúrate de tener el tipo correcto de las opciones.
// const options: PromptTemplateOptions<string[], string[], string> = {
//     template: `Context information from multiple sources is below:
//                {context}
//                Question: {query}
//                Answer:`,
//       // Las variables que la plantilla va a esperar recibir.
//   };
  
  // Crear una nueva instancia de PromptTemplate con el objeto options.
//   const treeSummarizePrompt: PromptTemplate<string[], string[], string> = new PromptTemplate(options);
  
  

// export const promptTemplateController = async (req: Request, res: Response) => {

//     const query = req.body.query;

//     const document = new Document({
//         text: `Código de ética CompuSoluciones.
